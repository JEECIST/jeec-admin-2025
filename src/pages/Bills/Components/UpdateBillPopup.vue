        ...
        <div class="desktop" >
            <div class="wrapper-wrapper">
                <div class="popup-wrapper" ref="target">
                        ...
                        <div class="flex-2">
                            <div class="flex-1-row-1">
                                <div class="labels" id="status">
                                    ...
                                    <select required name="status" id="status" v-model="updated_bill_data.status" :selected="updated_bill_data.status">
                    ...
                    <div class="btns">
                        <button class="add" @click="updateBill" >Update</button>
                    </div>
                </div>
            </div>
        </div> 
